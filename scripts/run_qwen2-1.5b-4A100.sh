        ...
        for bias in "${biases[@]}"; do
            for model_size in "${model_sizes[@]}"; do
                python3 -m verl.trainer.main_ppo \
                    ...
                    trainer.experiment_name="qwen2_${model_size}b_grpo_kl_${kl}_bs_${batch_sizes}_mbs_${MINI_BATCH_SIZE}_n_4_advantage_minus_${bias}_per_response_norm_shuffle_method_2" \
